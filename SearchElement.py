...
def search_element(lst, element):
    if element in lst:
        return f"{element} is present in the given list"
    else:
        return f"{element} is not present in the given list"
...
# Searching for the element and printing the result
result = search_element(lst, element)
print(result)
